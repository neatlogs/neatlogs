...
actual final masked envelope. Use `doctor --probe` to export a controlled trace
...
To verify the complete ingestion path through the hosted diagnostic receipt endpoint:
