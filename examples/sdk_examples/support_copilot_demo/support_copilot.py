...
neatlogs.init(
    ...
    workflow_name="support-copilot",
    tags=["sdk-examples", "support-copilot", "azure-openai", "chroma"],
...
def handle_support_ticket() -> dict:
    ...
    # Mapped to neatlogs.input.value and neatlogs.workflow.input on export.
...
def run_a():
    ...
    _activate_run(
        ...
        system_tpl=SUPPORT_DRAFTER_SYSTEM_V3,  # v3 used in A; v3 issue is irrelevant here
...
def run_b():
    ...
    _activate_run(
        ...
        coll=build_collection(SEEDS_BROKEN_RUN_B),  # v3.0 missing
        system_tpl=SUPPORT_DRAFTER_SYSTEM_V3,  # broken
        user_tpl=SUPPORT_DRAFTER_USER,
    )
    return handle_support_ticket()
