...
def _make_agents():
    ...
    context_analyzer = Agent(
        ...
        llm=neatlogs.bind_templates(LLM(model=f"azure/{AZURE_LLM_DEPLOYMENT}", base_url=AZURE_OPENAI_ENDPOINT, api_key=AZURE_OPENAI_API_KEY, api_version=OPENAI_API_VERSION), context_analyzer_tpl),
    ...
    email_generator = Agent(
        ...
        tools=[],
        llm=neatlogs.bind_templates(LLM(model=f"azure/{AZURE_LLM_DEPLOYMENT}", base_url=AZURE_OPENAI_ENDPOINT, api_key=AZURE_OPENAI_API_KEY, api_version=OPENAI_API_VERSION), email_generator_tpl),
        allow_delegation=False,
        max_iter=5,
        max_retry_limit=3,
    )
