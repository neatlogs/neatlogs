...
Optional env vars:
    OPENAI_REASONING_MODEL   (default: o4-mini)
...
def run():
    ...
    # print("\n=== Agent 1: o4-mini (non-streaming, reasoning_effort=high) ===")
    # r1 = openai_reasoning_agent(PROBLEM)
    # print(f"\nAnswer:\n{r1}")

    # print("\n=== Agent 2: gpt-4o (streaming, temperature/top_p/seed/penalties) ===")
    # r2 = openai_full_params_agent(PROBLEM)

    # print("\n=== Agent 3: claude-3-7-sonnet (streaming, extended thinking) ===")
    # r3 = anthropic_thinking_agent(PROBLEM)

    # print("\n=== Agent 4: LangChain ChatOpenAI gpt-4o-mini (temperature/max_tokens/top_p) ===")
